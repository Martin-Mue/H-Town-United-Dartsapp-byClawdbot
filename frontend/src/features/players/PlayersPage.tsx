      ...
      return [
        {
          ...
          notes: 'Steady scoring, prefers D16 routes.',
          currentAverage: 69,
          checkoutPercentage: 34,
        ...
        },
        {
          ...
          notes: 'Explosive scoring but fluctuating under pressure.',
          currentAverage: 73,
          checkoutPercentage: 28,
          pressurePerformanceIndex: 61,
          total180s: 31,
          avatarUrl: '',
        },
        {
          ...
          preferredCheckoutMode: 'DOUBLE_OUT',
          notes: 'Excellent doubles, low 180 frequency.',
          currentAverage: 58,
          checkoutPercentage: 39,
          pressurePerformanceIndex: 77,
          total180s: 4,
          avatarUrl: '',
        },
        {
          id: 'p4',
          displayName: 'Timo Sander',
          preferredCheckoutMode: 'SINGLE_OUT',
          notes: 'Beginner profile for onboarding tests.',
          currentAverage: 42,
          checkoutPercentage: 18,
          pressurePerformanceIndex: 43,
          total180s: 0,
          avatarUrl: '',
        },
        {
          id: 'p5',
          displayName: 'Noah Krüger',
          preferredCheckoutMode: 'DOUBLE_OUT',
          notes: 'Strong clutch performer in deciders.',
          currentAverage: 65,
          checkoutPercentage: 32,
          pressurePerformanceIndex: 81,
          total180s: 12,
          avatarUrl: '',
        },
        {
          ...
          preferredCheckoutMode: 'DOUBLE_OUT',
          notes: 'Training candidate for checkout pressure mode.',
          currentAverage: 54,
          checkoutPercentage: 21,
          pressurePerformanceIndex: 49,
          total180s: 2,
          avatarUrl: '',
        },
      ];
